...
<head>
    ...
    <link rel="stylesheet" href="../../css/html_styles/structure.css">
...
&lt;/html&gt;
  ...
  <p>The very first line in any HTML document is the doctype declaration: <code class="code">&lt;!DOCTYPE html&gt;</code></p>
  ...
  <h3>The &lt;html&gt; Tag</h3>
  <p>
    The <code>&lt;html&gt;</code> element wraps the entire page content. The <code class="code">lang="en"</code> attribute specifies the language of the document as English.
  </p>
  ...
  <code class="code">&lt;!-- This is a comment --&gt;</code>
            ...
            <section id="navigator">
                <div id="cover">
                    <div class="spacing navigator">
                       <a href="../editors.php" target="_self">
                        <i class="fa-solid fa-arrow-left"></i>
                        <span>previous</span>
                       </a>

                       <a href="./lists.php" target="_self">
                        <span>next</span>
